...
mkdir "${ARCVIDEO_INSTALL_PREFIX}/openColorIO"
cp nuke-default/config.ocio "${ARCVIDEO_INSTALL_PREFIX}/openColorIO/"
cp -r nuke-default/luts "${ARCVIDEO_INSTALL_PREFIX}/openColorIO/"
