...
void ViewerPanelBase::SetFullScreen(QScreen* screen) const {
    GetViewerWidget()->SetFullScreen(screen);
}

void ViewerPanelBase::SetGizmos(Node* node) const {
    GetViewerWidget()->SetGizmos(node);
}

void ViewerPanelBase::CacheEntireSequence() const {
    GetViewerWidget()->CacheEntireSequence();
}

void ViewerPanelBase::CacheSequenceInOut() const {
