...
void SequenceDialog::SetAsDefaultClicked()
{
  if (QtUtils::MsgBox(this, QMessageBox::Question, tr("Confirm Set As Default"),
    ...
    ARCVIDEO_CONFIG("DefaultSequencePixelAspect") = QVariant::fromValue(parameter_tab_->GetSelectedVideoPixelAspect());
    ARCVIDEO_CONFIG("DefaultSequenceFrameRate") = QVariant::fromValue(parameter_tab_->GetSelectedVideoFrameRate().flipped());
    ...
    ARCVIDEO_CONFIG("DefaultSequenceAudioLayout") = QVariant::fromValue(parameter_tab_->GetSelectedAudioChannelLayout());
  }
}
