...
PreferencesDiskTab::PreferencesDiskTab()
{
  ...
  cache_ahead_slider_->SetValue(ARCVIDEO_CONFIG("DiskCacheAhead").value<rational>().toDouble());
  ...
  cache_behind_slider_->SetValue(ARCVIDEO_CONFIG("DiskCacheBehind").value<rational>().toDouble());
...
void PreferencesDiskTab::Accept(MultiUndoCommand *command)
{
  ...
  ARCVIDEO_CONFIG("DiskCacheBehind") = QVariant::fromValue(rational::fromDouble(cache_behind_slider_->GetValue()));
  ARCVIDEO_CONFIG("DiskCacheAhead") = QVariant::fromValue(rational::fromDouble(cache_ahead_slider_->GetValue()));
}
