...
AboutDialog::AboutDialog(bool welcome_dialog, QWidget* parent) : QDialog(parent) {
    ...
    auto* icon = new QLabel(QStringLiteral("<html><img src=':/graphics/arcvideo-splash.png'></html>"));
    ...
    if (welcome_dialog || patrons.isEmpty()) {
        ...
        opening_statement =
            tr("ArcVideo wouldn't be possible without the support of gracious donations from the following people.");
    }
