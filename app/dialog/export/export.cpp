  ...
  loading_presets_(false)
{
...

  {
    ...
    export_bkg_box_->setToolTip(tr("Exporting in the background allows you to continue using ArcVideo while "
...
void ExportDialog::SetDefaults()
{
  ...
  video_tab_->pixel_format_field()->SetPixelFormat(static_cast<PixelFormat::Format>(ARCVIDEO_CONFIG("OnlinePixelFormat").toInt()));
