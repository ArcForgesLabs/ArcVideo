 ...
 * rather than browsing through the menu bar. This can be created from anywhere provided arcvideo::MainWindow is valid.
 */
...
private slots:
     ...
     *
     * Usually triggered by pressing Enter on the ActionSearchEntry field, this will trigger whatever action is
     * currently highlighted and then close this popup. If no entries are highlighted (i.e. the list is empty), no
     * action is triggered and the popup closes anyway.
     */
    void perform_action();
