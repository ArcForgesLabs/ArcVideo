...
public:
    ...
    [[nodiscard]] inline std::vector<TimelineMarker*>::const_iterator begin() const { return markers_.cbegin(); }
    [[nodiscard]] inline std::vector<TimelineMarker*>::const_iterator end() const { return markers_.cend(); }
