...
#ifndef LIBARCVIDEOCORE_TIMECODEFUNCTIONS_H
#define LIBARCVIDEOCORE_TIMECODEFUNCTIONS_H

#include "rational.h"

namespace arcvideo::core {

/**
 * @brief Functions for converting times/timecodes/timestamps
 *
 * ArcVideo uses the following terminology through its code:
 *
...
#endif // LIBARCVIDEOCORE_TIMECODEFUNCTIONS_H
