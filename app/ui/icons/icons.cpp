...
/// Internal icon library for use throughout ArcVideo without having to regenerate constantly
...
QIcon icon::Create(const QString& theme, const QString& name) {
    ...
    for (int i : ICON_SIZES) {
        icon.addFile(QStringLiteral("%1/png/%2.%3.png").arg(theme, name, QString::number(i)), QSize(i, i),
                     QIcon::Normal);
