        ...
        if (reader->name() == QStringLiteral("folders")) {
            while (XMLReadNextStartElement(reader)) {
                if (reader->name() == QStringLiteral("folder")) {
                    ...
                    auto* open_item = static_cast<Folder*>(node_ptrs.value(item_id));
            ...
            while (XMLReadNextStartElement(reader)) {
                if (reader->name() == QStringLiteral("sequence")) {
                    ...
                    auto* open_seq = static_cast<Sequence*>(node_ptrs.value(item_id));
...
void MainWindowLayoutInfo::add_folder(arcvideo::Folder* f) {
