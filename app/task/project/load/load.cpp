...
bool ProjectLoadTask::Run()
{
  ...
  case ProjectSerializer::kProjectTooOld:
    SetError(tr("This project is from a version of ArcVideo that is no longer supported in this version."));
    break;
  case ProjectSerializer::kProjectTooNew:
    SetError(tr("This project is from a newer version of ArcVideo and cannot be opened in this version."));
    break;
