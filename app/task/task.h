...
/**
 * @brief A base class for background tasks running in ArcVideo.
 *
 ...
 * certain media file can be used in ArcVideo. Even if the probe *fails* to find a Decoder for this file, the Task
 * itself has *succeeded* at discovering this. A failure of ProbeTask would indicate a catastrophic failure meaning it
 * was unable to determine anything about the file.
 *
