...
ConformTask::ConformTask(QString decoder_id, const Decoder::CodecStream& stream, const AudioParams& params,
                         const QVector<QString>& output_filenames)
    : decoder_id_(std::move(decoder_id)), stream_(stream), params_(params), output_filenames_(output_filenames) {
