...
/**
 * @brief The main central ArcVideo application instance
 *
 * This runs both in GUI and CLI modes (and handles what to init based on that).
 * It also contains various global functions/variables for use throughout ArcVideo.
 *
...
public:
     ...
     * @return
     *
     * Pointer to the arcvideo::MainWindow object, or nullptr if running in CLI mode.
     */
     ...
     *
     * Uses the UI/Panel system to determine which Project was the last focused on and assumes this is the active
     * Project that the user wishes to work on.
     *
     * @return
     *
...
private:
    ...
    /**
     * @brief Start GUI portion of ArcVideo
     *
     * Starts services and objects required for the GUI of ArcVideo. It's guaranteed that running without this function
     * will create an application instance that is completely valid minus the UI (e.g. for CLI modes).
     */
     ...
     */
    void AddOpenProject(arcvideo::Project* p, bool add_to_recents = false);
