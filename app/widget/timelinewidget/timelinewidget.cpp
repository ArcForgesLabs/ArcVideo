...
void TimelineWidget::ShowContextMenu()
{
  ...
  if (selected.isEmpty()) {
...

    {
      ...
      thumbnail_menu->AddActionWithData(tr("Disabled"), Timeline::kThumbnailOff, ARCVIDEO_CONFIG("TimelineThumbnailMode"));
      thumbnail_menu->AddActionWithData(tr("Only At In Points"), Timeline::kThumbnailInOut, ARCVIDEO_CONFIG("TimelineThumbnailMode"));
      thumbnail_menu->AddActionWithData(tr("Enabled"), Timeline::kThumbnailOn, ARCVIDEO_CONFIG("TimelineThumbnailMode"));
