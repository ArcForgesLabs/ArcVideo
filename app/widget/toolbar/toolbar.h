...
/**
 * @brief A widget containing buttons for all of ArcVideo's application-wide tools.
 *
...
public slots:
     ...
     *
     * Similar to SetTool(), this does not set anything application-wide, it only changes the displayed button
     * appearance. In this case, whether the snapping button should show as snapping enabled or disabled.
     *
     * @param snapping
     */
...
private:
     ...
     * the widget layout, add it to toolbar_btns_ so the buttons can be iterated (done in various functions), and
     * connect the button to ToolButtonClicked().
     *
