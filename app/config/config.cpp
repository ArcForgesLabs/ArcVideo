...
void Config::SetDefaults()
{
  ...
  SetEntryInternal(QStringLiteral("DefaultVideoTransition"), NodeValue::kText, QStringLiteral("org.arcvideoeditor.ArcVideo.crossdissolve"));
  SetEntryInternal(QStringLiteral("DefaultAudioTransition"), NodeValue::kText, QStringLiteral("org.arcvideoeditor.ArcVideo.crossdissolve"));
