...
#ifndef ARCVIDEOCOMMONDEFINE_H
#define ARCVIDEOCOMMONDEFINE_H
...
#define ARCVIDEO_NS_CONST_ARG(x, y) QArgument<const arcvideo::x>("const " MACRO_VAL_AS_STR(arcvideo) "::" #x, y)
#define ARCVIDEO_NS_ARG(x, y) QArgument<arcvideo::x>(MACRO_VAL_AS_STR(arcvideo) "::" #x, y)
#define ARCVIDEO_NS_RETURN_ARG(x, y) QReturnArgument<arcvideo::x>(MACRO_VAL_AS_STR(arcvideo) "::" #x, y)
