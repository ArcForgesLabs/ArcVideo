...
public:
     ...
     */
    [[nodiscard]] inline bool IsAllocated() const { return !arenas_.empty(); }

    /**
     * @brief Returns current number of allocated arenas
     */
    [[nodiscard]] inline int GetArenaCount() const { return arenas_.size(); }
    ...
    public:
        ...
        [[nodiscard]] inline const int64_t& timestamp() const { return timestamp_; }
         ...
         */
        [[nodiscard]] inline const int64_t& last_accessed() const { return accessed_; }
    ...
    public:
        ...
        [[nodiscard]] inline int GetElementCount() const { return available_.size(); }

        [[nodiscard]] inline bool IsAllocated() const { return data_; }
