...
/**
 * @brief A decoder's is the main class for bringing external media into ArcVideo
 *
...
protected:
    ...
    [[nodiscard]] virtual rational GetAudioStartOffset() const { return 0; }
...
private:
    ...
    bool RetrieveAudioFromConform(SampleBuffer& sample_buffer, const QVector<QString>& conform_filenames,
                                  TimeRange range, LoopMode loop_mode, const AudioParams& params);
...
Q_DECLARE_METATYPE(arcvideo::Decoder::RetrieveState)
