...
const int VideoParams::kInternalChannelCount = kRGBAChannelCount;  // NOLINT(cppcoreguidelines-interfaces-global-init)
...
void VideoParams::Save(QXmlStreamWriter* writer) const {
    ...
    writer->writeTextElement(QStringLiteral("pixelaspectratio"),
