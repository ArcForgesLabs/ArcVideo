...
QString SubtitleParams::GenerateASSHeader() {
    ...
    ass_code.append(QStringLiteral("&H%1,&H%2,&H%3,&H%4,")
                        .arg(QString::number(kAssDefaultPrimaryColor, 16),
                             ...
                             QString::number(kAssDefaultOutlineColor, 16), QString::number(kAssDefaultBackColor, 16)));

    // Bold, Italic, Underline, StrikeOut
    ass_code.append(QStringLiteral("%1,%2,%3,%4,")
                        .arg(QString::number(kAssBold), QString::number(kAssItalic), QString::number(kAssUnderline),
