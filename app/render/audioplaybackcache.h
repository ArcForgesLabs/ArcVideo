 ...
 *
 * All audio in ArcVideo is processed and rendered in advance. This makes playback extremely smooth
 ...
 *
 * ArcVideo's PlaybackCaches support "shifting"; moving cached data to a different spot on the
