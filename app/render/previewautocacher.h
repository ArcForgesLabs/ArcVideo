...
private slots:
     ...
     */
    void VideoInvalidatedFromCache(ViewerOutput* context, const arcvideo::TimeRange& range);

    /**
     * @brief Handler for when the NodeGraph reports a audio change over a certain time range
     */
    void AudioInvalidatedFromCache(ViewerOutput* context, const arcvideo::TimeRange& range);
