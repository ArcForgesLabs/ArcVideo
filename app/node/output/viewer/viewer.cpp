...
void ViewerOutput::set_default_parameters()
{
  ...
  SetVideoParams(VideoParams(
                   width,
                   height,
                   ARCVIDEO_CONFIG("DefaultSequenceFrameRate").value<rational>(),
  ...
  SetAudioParams(AudioParams(
      ARCVIDEO_CONFIG("DefaultSequenceAudioFrequency").toInt(),
      ARCVIDEO_CONFIG("DefaultSequenceAudioLayout").toULongLong(),
