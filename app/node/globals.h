...
public:
    ...
    NodeGlobals(VideoParams vparam, const AudioParams& aparam, const TimeRange& time, LoopMode loop_mode)
        : video_params_(std::move(vparam)), audio_params_(aparam), time_(time), loop_mode_(loop_mode) {}
...
private:
    ...
    TimeRange time_;
    LoopMode loop_mode_{LoopMode::kLoopModeOff};
};
