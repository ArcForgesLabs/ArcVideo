...
public:
    ...
    [[nodiscard]] rational toRational() const { return value<arcvideo::foundation::rational>(); }
    [[nodiscard]] QString toString() const { return value<QString>(); }
    [[nodiscard]] Color toColor() const { return value<arcvideo::foundation::Color>(); }
...
public:
    ...
    template <typename T>
    void Push(NodeValue::Type type, const T& data, const Node* from, bool array = false,
...
Q_DECLARE_METATYPE(arcvideo::NodeValue)
Q_DECLARE_METATYPE(arcvideo::NodeValueTable)
