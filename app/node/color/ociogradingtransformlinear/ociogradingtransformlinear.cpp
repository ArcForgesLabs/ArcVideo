...
QString OCIOGradingTransformLinearNode::id() const {
    return QStringLiteral("org.arcvideoeditor.ArcVideo.ociogradingtransformlinear");
}
...
void OCIOGradingTransformLinearNode::Value(const NodeValueRow& value, const NodeGlobals& globals,
    ...
    if (TexturePtr tex = value[kTextureInput].toTexture()) {
        if (processor()) {
            ...
            job.Insert(kOffsetInput, NodeValue(NodeValue::kVec3, QVector3D(offset[RED_CHANNEL], offset[GREEN_CHANNEL],
                                                                           offset[BLUE_CHANNEL])));
            ...
            job.Insert(kExposureInput,
                       NodeValue(NodeValue::kVec3,
                                 QVector3D(exposure[RED_CHANNEL], exposure[GREEN_CHANNEL], exposure[BLUE_CHANNEL])));
            ...
            job.Insert(kContrastInput,
                       NodeValue(NodeValue::kVec3,
                                 QVector3D(contrast[RED_CHANNEL], contrast[GREEN_CHANNEL], contrast[BLUE_CHANNEL])));
