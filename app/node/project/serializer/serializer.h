...
public:
    enum LoadType { kProject, kOnlyNodes, kOnlyClips, kOnlyMarkers, kOnlyKeyframes };
    ...
    class SaveData {
    public:
        SaveData(LoadType type, Project* project = nullptr, QString filename = QString())
            : type_(type), project_(project), filename_(std::move(filename)) {}
