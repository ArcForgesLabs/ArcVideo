...
public:
  ...
  {
    return QStringLiteral("org.arcvideoeditor.ArcVideo.transform");
  }
...
protected slots:
  virtual void GizmoDragStart(const arcvideo::NodeValueRow &row, double x, double y, const arcvideo::rational &time) override;
