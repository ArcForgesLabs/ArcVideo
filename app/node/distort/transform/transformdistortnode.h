...
public:
    ...
    QString id() const override { return QStringLiteral("org.arcvideoeditor.ArcVideo.transform"); }
...
protected slots:
    void GizmoDragStart(const arcvideo::NodeValueRow& row, double x, double y, const arcvideo::rational& time) override;
...
private:
    ...
    static QMatrix4x4 GenerateAutoScaledMatrix(const QMatrix4x4& generated_matrix, const NodeValueRow& db,
